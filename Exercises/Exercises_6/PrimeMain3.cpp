...
int main(int argc, char **argv) {
  	...
  	if(nprocesses >= 2){
    	...
    	if(myrank == 0){
      		...
      		ps1 -> initFilter(1, SMAXP/nprocesses, SMAXP);
    	...
    	else if(myrank == nprocesses-1){
      		PrimeServer *ps3 = new PrimeServer();

      		ps3 -> initFilter((myrank*SMAXP/nprocesses)+1, SMAXP, SMAXP);
      		...
      		ps2 -> initFilter((myrank*SMAXP/nprocesses)+1, ((myrank+1)*SMAXP/nprocesses)+1, SMAXP);
